...
export const ru: TranslationResources = {
  ...
  sideConversations: {
    title: "Параллельный разговор",
    composer: {
      placeholder: "Задайте параллельный вопрос...",
      send: "Спросить",
      pending: "Отправка вопроса...",
    },
    states: {
      loading: "Загрузка параллельного разговора...",
      empty: "Задайте вопрос, не прерывая основную задачу агента.",
      pending: "Ожидание ответа...",
      removed: "Этого параллельного разговора больше нет на хосте.",
    },
    errors: {
      unavailable: "Параллельные разговоры недоступны для этого агента.",
      sessionClosed: "Этот агент завершил работу, пока вопрос был в обработке.",
      timeout: "Время ожидания параллельного разговора истекло.",
      failed: "Сбой параллельного разговора: {{error}}",
      duplicate: "Параллельный вопрос уже выполняется.",
    },
    notices: {
      singleShot: "Этот провайдер поддерживает только один вопрос за раз.",
      degraded: "Этот ответ может не включать полный контекст разговора агента.",
    },
    actions: {
      openRow: "Открыть параллельный разговор",
      open: "Открыть",
      new: "Новый параллельный разговор",
    },
  },
  composer: {
    placeholders: {
