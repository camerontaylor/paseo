...
| [side-conversations-follow-ups.md](side-conversations-follow-ups.md) | Handover for the unlanded side-conversations feature on `read/side-conversations-phase1-plan`: seven follow-ups after the review fix pass, plus the gotchas that cost time. Delete when the branch lands and the follow-ups are closed. |
